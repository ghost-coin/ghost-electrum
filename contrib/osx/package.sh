...
if [ -z "$1" ]; then
    echo "Usage: $0 GhostElectrum.app"
    exit -127
fi
...
dmg dmg GhostElectrum_uncompressed.dmg Ghostelectrum-$VERSION.dmg || fail "Unable to create compressed dmg"
rm GhostElectrum_uncompressed.dmg
